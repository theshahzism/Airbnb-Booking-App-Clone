      ...
      {action === "new" && (
        <div>
          <form action="">
            ...
            <p className="text-gray-500 text-sm">
              Select all the relevent perks
            </p>
            <div className="grid gap-1 grid-cols-2 md:grid-cols-3 lg:grid-cols-6 mt-4">
            ...
            <p className="text-gray-500 text-sm">House rules or etc</p>
            <textarea></textarea>
